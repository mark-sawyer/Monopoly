...
public class TokenVisual : MonoBehaviour {
    ...
    public void setup(PlayerInfo player, SpaceVisualManager spaceVisualManager) {
        ...
        tokenSprites = GetPlayerScriptableObjects.tokenTypeToTokenSprites(player.Token);
        tokenColours = GetPlayerScriptableObjects.playerColourToTokenColours(player.Colour);
    }
