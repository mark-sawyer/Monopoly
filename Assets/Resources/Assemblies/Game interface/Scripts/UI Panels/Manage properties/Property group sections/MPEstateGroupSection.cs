...
public class MPEstateGroupSection : MPPropertyGroupSection {
    [SerializeField] private Transform panelSectionsTransform;
    [SerializeField] private EstateColour estateColour;

    public override Color TransitionPanelColour => EstateGroupDictionary.Instance.lookupColour(estateColour).PanelColour.Colour;
